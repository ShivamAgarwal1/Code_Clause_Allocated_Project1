...
class Player(tk.Frame):
    ...
    def create_frames(self):
        self.track = tk.LabelFrame(self, text = 'Your Track',
                     font=("times new roman",15,"bold"),
                     bg="pink",fg="red", bd=5,relief=tk.GROOVE)
    ...
    def track_widgets(self):
        ...
        self.songtrack = tk.Label(self.track, font=("times new roman",15,"bold"), bg='pink', fg='red')
        self.songtrack['text'] = "Shivam's Music Player"
        self.songtrack.configure(width=30, height=1)
        self.songtrack.grid(row=1, column=0)

    def control_widgets(self):
        self.loadSongs = tk.Button(self.controls, bg='pink', fg='red',font=10)
    ...
    def play_song(self, event=None):
        ...
        self.list.itemconfigure(self.current, bg='red')
        mixer.music.play()
